...
#MakeItTalk Modul kutuphaneleri
import sys
...
os.environ['GOOGLE_APPLICATION_CREDENTIALS'] = r'C:\Users\HP\Desktop\tezSon\t2sproject-350222-ef3d8302ab97.json'
os.environ['TORCH_HOME'] = 'pytorch'

#text2speech API icin gerekli wav dosyasını ureten fonksiyon
def text_to_wav(voice_name: str, text: str):
    ...
    filename= "examples/tr-TR.wav"
    with open(filename, "wb") as out:
        out.write(response.audio_content)

def speechAnimation():
    default_head_name = 'osman'
    ADD_NAIVE_EYE = True
    ...
    if request.method == 'POST':
        ...
        if (resp.status_code == 200):
            ...
            for i in range(len(returnList)):
                text2s = returnList[i]['reply']
                return_sum_message += text2s
            text_to_wav("tr-TR-Standard-E", return_sum_message)
            speechAnimation()
